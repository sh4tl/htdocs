...
<body>
	...
	function validate_form() {
		...
		$input['main_dish'] = isset($_POST['main_dish']) ? $_POST['main_dish'] : array();
		...
		// достоверности
			if (! (array_key_exists($input['main_dish'][0],
				$GLOBALS['main_dishes']) &&	array_key_exists($input['main_dish'][1], $GLOBALS['main_dishes']))) {
		...
		$input['comments'] = isset($_POST['comments']) ? trim($_POST['comments']) : '';
